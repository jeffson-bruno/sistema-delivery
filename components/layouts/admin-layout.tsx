...
import { LayoutDashboard, CreditCard, BarChart3, Settings, LogOut, Menu, X, UtensilsCrossed } from "lucide-react"
...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "Caixa", href: "/pdv", icon: CreditCard },
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="h-16 flex items-center gap-3 px-6 border-b border-sidebar-border">
            ...
            <div>
              <h1 className="font-bold text-lg text-sidebar-foreground">Sistema Delivery</h1>
            </div>
          </div>
